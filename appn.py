    ...
    with col_submit:
        if st.button("Submit"):
            ...
            document_data = {
                ...
                'other_indication':st.session_state['other_indication'],
                'other_tube_change':st.session_state['other_tube_change'],
            ...
            pdf_template = 'dcf_v3.pdf'  # Replace this with the correct path to your PDF template
            ...
            data['other_course_fail'] = data['other_course_fail'].apply(
                lambda x: 'X' if x == True else '' if x == False else x
            )
            ...
            for j, rows in data.iterrows():
                ...
                'other_indication': str(rows['other_indication']),
                'other_tube_change': str(rows['other_tube_change']),

                'nature_of_change_1': str(rows['nature_of_change_1']),
                'nature_of_change_2': str(rows['nature_of_change_2']),

                'tube_change_1': str(rows['tube_change_indications_1']),
                'tube_change_2': str(rows['tube_change_indications_2']),
                'tube_change_3': str(rows['tube_change_indications_3']),
                'tube_change_4': str(rows['tube_change_indications_4']),
                'tube_change_5': str(rows['tube_change_indications_5']),
                'tube_change_6': str(rows['tube_change_indications_6']),
                'tube_change_7': str(rows['tube_change_indications_7']),
                'tube_change_8': str(rows['tube_change_indications_8']),
                ...
                'selected_techniques_1': str(rows['selected_techniques_1']),
                'selected_techniques_2': str(rows['selected_techniques_2']),
                'selected_techniques_3': str(rows['selected_techniques_3']),
                'selected_techniques_4': str(rows['selected_techniques_4']),
                'selected_techniques_5': str(rows['selected_techniques_5']),
                'selected_techniques_6': str(rows['selected_techniques_6']),
                'selected_techniques_7': str(rows['selected_techniques_7']),
                ...
                "course_fail_4": str(rows['other_course_fail']),
