...
if st.session_state.page == "Encounter Information":
    ...
    with col9:
        ...
        st.session_state.form_data['attending_physician_present'] = st.selectbox(
            ...
            index=["Select if Attending Physician Present","No Attending Physician Present", "ckrawiec@pennstatehealth.psu.edu", "gceneviva@pennstatehealth.psu.edu", "rkavanagh@pennstatehealth.psu.edu"].index(st.session_state.form_data.get('attending_physician_present', "No Attending Physician Present"))
        )
